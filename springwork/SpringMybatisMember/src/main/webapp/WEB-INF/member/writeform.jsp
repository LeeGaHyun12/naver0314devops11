...
<script type="text/javascript">
    ...
    $(function(){
        ...
        //아이디를 입렫시 다시 중복확인을 누르도록 중복변수를 초기화
        $("#myid").keyup(function (){
            jungbok=false;
        });
    }); //close function
...
<form action="./insert" method="post" enctype="multipart/form-data" onsubmit="return check()">
    <table class="table table-bordered" style="width: 400px;">
        ...
        <tr>
            <tㅊh width="100" class="table-info">이름</tㅊh>
            <td>
        ...
        <tr>
            ...
            <td rowspan="2">
                <img src="" id="showimg1" style="border-radius:50%;width: 100%;"
                onerror="this.src='../image/saram.png'">
            </td>
        </tr>
        <tr>
