    ...
    <script type="text/javascript">
        $(function (){
            ...
            $("#photoupload").change(function (){
                ...
                form.append("upload",$("#photoupload")[0].files[0]); //업로드라는 이름으로 파일명을 보내고
                ...
                */
                $.ajax({
                    ...
                    success:function(data){
                        ...
                        //프로필 사진 변경 (db 변경 후 업로드 된 사진파일명을 반환받은 것으로 변경
                        $("#photo").attr("src","../image/"+data.photoname); //업로드된 파일명
                    }
                });
            });
        });
...
<table class="table" style="width: 500px;margin:20px;">
    ...
    <tr>
        <td width="200" align="center">
            ...
            <button type="button" class="btn btn-success btn-sm" onclick="$('#photoupload').trigger('click')">
                사진수정</button>
        </td>
        <td>
            아이디 : ${dto.myid}<br>
