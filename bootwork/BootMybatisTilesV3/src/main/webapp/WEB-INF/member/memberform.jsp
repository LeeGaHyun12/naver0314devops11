...
<body>
<form class="form form-primary" action="./insert" method="post" enctype="multipart/form-data"
      onsubmit="return check()">
    <table class="table table-light" style="width: 700px;">
        <caption align="top" style="margin-left: 300px;">
            <h3><b>회원 가입</b></h3>
        </caption>
        <tr>
