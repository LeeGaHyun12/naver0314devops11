    ...
    <div id="carouselExampleSlidesOnly" class="carousel slide" data-bs-ride="carousel">
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img src="../image/먹태깡.png" class="d-block w-50 mx-auto" alt="이미지 1"></a>
            </div>
            ...
            <div class="carousel-item">
                <img src="../image/꼬북칩.png" class="d-block w-50 mx-auto" alt="이미지 5">
            </div>
            <div class="carousel-item">
                <img src="../image/포카칩.png" class="d-block w-50 mx-auto" alt="이미지 6">
            </div>
        </div>
