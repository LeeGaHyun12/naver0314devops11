...
public class Ex15_FileException {
	static final String FILENAME="/Users/igahyeon/Desktop/naver0314/memo1.txt";
	static final String FILENAME2="/Users/igahyeon/Desktop/naver0314/memo2.txt";
    ...
    static public void fileSave2() throws IOException{
    	...
    	while(true) {
    	  ...
    	  System.out.println("입력한 정보를 파일엥 저장합니다");
    	  fw.write("이름: "+name+"\n");
    	  fw.write("핸드폰: "+hp+"\n");
    	  fw.write("주소: "+addr+"\n");
    	  fw.write("=".repeat(15)+"\n");
