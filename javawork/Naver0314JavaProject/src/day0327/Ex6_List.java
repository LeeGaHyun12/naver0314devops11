...
public class Ex6_List {
	...
	public static void main(String[] args) {
		...
		//System.out.println("list1에 할당된 갯수: "+((Vector<String>)list1).capacity());//capacity는 오버라이드 메서드가 아니고 Vector가 갖고있는 메서드

		System.out.println("list2 데이터 갯수: "+list2.size());
		//System.out.println("list3에 할당된 갯수: "+((Vector<String>)list2).capacity());
